    ...
    return (
      <div>
        ...
        <div className="col s12 fullWidth hide-on-med-and-down">
          <img src="/especialView.png" className="responsive-img roundedBorder littleSpaceTop borderStrong innerPadding fullWidth"></img>
        </div>
        <div className="col s12 fullWidth no-margin-padding-sides hide-on-large-only">
          <div className="row grey lighten-3 no-margin-top fullWidth OpenSansFont bold black-text heightMobile valign-wrapper">
            ...
            <img src="/tottus_logo.png" className="col s4 right responsive-img"></img>
          </div>
          <img src="/especialViewMobile.png" className="responsive-img littleSpaceTop innerPadding fullWidth"></img>
        </div>
      </div>
    );
  }
