...
class VideoContainer extends Component {
  render() {
    return (
      <div>
        <img src="/momTottus.png" className="responsive-img roundedBorder fullWidth"></img>
          ...
          <div className="row card white green-text text-darken-4 innerPadding center margined">
            <div className="valign-wrapper margined">
              <div className="col l2 hide-on-med-and-down">
                <img src="/focoIcon.png"></img>
              </div>
              <div className="col s12 l7">
                <h6 className="bold"><span><img className="col l2 hide-on-large-only" src="/focoIconSmall.png"></img></span>Ut enim ad
                  minim veniam</h6>
